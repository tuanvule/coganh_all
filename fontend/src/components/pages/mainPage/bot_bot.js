...
export default function Bot_Bot() {
  ...
  useEffect(() => {
    fetch("https://coganh.onrender.com/get_rank_board", {
      method: "GET",
    })
      .then(res => res.json())
      .then(data => {
  ...
  useEffect(() => {
    if (user.username) {
      fetch("https://coganh.onrender.com/get_user_bots", {
        method: "POST",
        headers: {
  ...
  useEffect(() => {
    ...
    function updateRankBoard(newValue) {
      ...
      fetch("https://coganh.onrender.com/update_rank_board", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    fightBtn.onclick = () => {
      ...
      fetch("https://coganh.onrender.com/fight_bot", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
