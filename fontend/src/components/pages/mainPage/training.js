...
export default function Training() {
    ...
    var task_id = id
    if(task.hasOwnProperty("task_name")) {
    ...
    const [code, set_code] = useState(default_code || "")
    ...
    useEffect(() => {
        fetch("https://coganh.onrender.com/get_task/" + task_id)
        .then(res => res.json())
        .then(data => {
            console.log(data)
            set_task(data)
    ...
    useEffect(() => {
        ...
        async function render_summissions(isfirstRender = false) {
            ...
            if (task.challenger.hasOwnProperty(username)) {
                ...
                if (isfirstRender) {
                    set_code(task.challenger[username].current_submit.code)
                }
            }
        }
    ...
    useEffect(() => {
        ...
        runBtn.onclick = () => {
            ...
            fetch("https://coganh.onrender.com/run_task", {
                method: "POST",
                headers: {
        ...
        function submitCode(code) {
            let formatter = new Intl.DateTimeFormat([], options);
            fetch("https://coganh.onrender.com/submit_code", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            <div className="CM_container">
                <div className="container_element bot_display">
                    ...
                    >
                        ...
                        <Comment_modal bg="bg-[#262626]" px="" task_id={task_id}/>
                    </div>
                    <div
                        style={{ display: "none" }}
                        ...
                        <div className="display_result accepted">
                            <div className="test_case_result">
                              ...
                              <div class="text_case_InOu accepted">
                                ...
                                <div
                                    style={{ display: "none" }}
                                    className="test_case_result_err"
                                ></div>
                            </div>
                            <div className="change_task_block">
                                <div className="pre_task">back</div>
                                <div className="next_task available">next</div>
                            </div>
                        </div>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <ul className="submissions_list"></ul>
                    </div>
                    <div
                        style={{ display: "none" }}
