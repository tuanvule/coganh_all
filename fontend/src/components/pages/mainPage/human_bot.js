...
`
        ...
        rate_btn.onclick = () => {
            ...
            if (rateModel) return
            rateModel = true
            fetch("https://coganh.onrender.com/get_rate", {
                method: "POST",
                headers: {
        ...
        function getBotmove() {
            ...
            setTimeout(() => {
                ...
                fetch("https://coganh.onrender.com/get_pos_of_playing_chess", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                    },
        ...
        <div className="flex h-screen justify-around items-center">
            <div className="game_state pc">
                ...
                <div className="game_turn game_turn-player">
                    <div className="player_avatar">T</div>
                    <div className="game_turn_info player_info_pc">
                        <div className="player_info_name">tlv23</div>
                    </div>
                </div>
            </div>
